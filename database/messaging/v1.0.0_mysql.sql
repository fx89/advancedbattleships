...
CREATE TABLE IF NOT EXISTS `PERSISTENT_MESSAGE` (
    ...
    `SOURCE_UNIQUE_TOKEN` CHAR   (  12) BINARY NOT NULL,
...
INSERT INTO `PERSISTENT_MESSAGE_CHANNEL`(`NAME`, `MESSAGE_TYPE_ID`)
	...
	UNION ALL SELECT 'game invitations', (SELECT MAX(`ID`) FROM `PERSISTENT_MESSAGE_TYPE` WHERE `NAME` = 'game invitation')
...
INSERT INTO `PERSISTENT_MESSAGE_SOURCE_TYPE`(`NAME`) VALUES
	('user'),
	('system')
;
